   ...
   <!-- feature_part start-->
    ...
    <section class="title-section">
        <div class="container wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Daftar Perjanjian dengan Pihak Ketiga </h1>
                </div>
            </div>
        </div>
    </section>
	...
	<section>
                <div class="col-lg-12">
					<iframe src="https://cc.sumedangkab.go.id/iframe" name="iframe_a" height="800px" width="100%" title="Iframe Example"></iframe>
                </div>
    </section>
