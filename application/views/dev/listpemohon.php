...
<head>
    <title>Daftar Permohonan Informasi Publik - PPID Kab. Sumedang</title>
                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($permohonan as $dok_kec) : ?>
                                            <tr>
                                                <td>
                                                    <?php echo $dok_kec->tanggal ?>
                                                </td>
                                                <td>
                                                    <?php echo $dok_kec->tanggaljawab ?>
                                                </td>
                                                <td>
                                                    <?php echo $dok_kec->rincian?>
                                                </td>
                                                <td>
                                                    <?php echo $dok_kec->tujuan ?>
                                                </td>
                                                <td>
                                                    <?php echo $dok_kec->caraperoleh ?>
                                                </td>
                                                <td>
                                                    <?php echo $dok_kec->caradapat?>
                                                </td>
                                                <td>
                                                    <?php echo $dok_kec->status?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
