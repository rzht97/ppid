                                    ...
                                    <div style="background-color: #fff; padding: 35px; border-radius: 8px; border: 2px solid #e0e0e0; margin-top: 25px;">
                                        ...
                                        <form action="<?= base_url()?>keberatan/save" method="post">
                                            ...
                                            <div class="form-group" style="margin-bottom: 30px;">
                                                ...
                                                <textarea class="form-control" name="kronologi" rows="7" required style="padding: 10px 14px; font-size: 14px; border-radius: 5px; border: 1px solid #d1d5db; line-height: 1.4; resize: vertical; font-family: inherit;"></textarea>
