                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget__column footer-widget__explore clearfix">
                                <h3 class="footer-widget__title">Layanan Informasi</h3>
                                <ul class="footer-widget__explore-list list-unstyled">
                                    <li><a href="<?php echo site_url('pub/overview/caradapatinfo')?>">Tata Cara Permohonan Informasi</a></li>
                                    <li><a href="<?php echo site_url('pub/overview/carakeberatan')?>">Tata Cara Keberatan Atas Informasi</a></li>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget__column footer-widget__explore clearfix">
                                ...
                                <ul class="footer-widget__explore-list list-unstyled">
                                    <li><a href="<?php echo site_url('pub/overview/infoberkala')?>">Berkala</a></li>
                                    <li><a href="<?php echo site_url('pub/overview/infosertamerta')?>">Serta Merta</a></li>
                                    <li><a href="<?php echo site_url('pub/overview/infosetiapsaat')?>">Setiap Saat</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- <div class="col-xl-5 col-lg-6 col-md-8 wow fadeInUp" data-wow-delay="400ms">
                            <div class="footer-widget__column footer-widget__newsletter">
                                <h3 class="footer-widget__title footer-widget__title-news">Klasifikasi Informasi</h3>
                        ...
                        <div class="col-xl-12">
                            <div class="site-footer-bottom__inner">
                                ...
                                <div class="site-footer__social">
                                    <a href="https://www.facebook.com/diskominfosanditiksumedang" target="_blank" rel="noopener noreferrer" class="clr-fb" aria-label="Facebook"><i class="fab fa-facebook"></i></a>
                                    <a href="https://www.instagram.com/humassumedang/" target="_blank" rel="noopener noreferrer" class="clr-ins" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
