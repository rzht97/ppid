...
<head>
    <title>SOP Pelayanan Informasi - PPID Kab. Sumedang</title>
                ...
                <div id="pdf-viewer"
                    ...
                    <div id="pdf-controls"
                        ...
                        <div style="display: inline-block; margin: 5px;"><button id="fullscreen-btn"
                                ...
                                href="<?= base_url(); ?>upload/product/SOP%20Pelayanan%20Informasi.pdf"
                                download="SOP_Pelayanan_Informasi.pdf" class="btn btn-sm btn-success"
                                style="margin: 0 5px;"><i class="fa fa-download"></i> <span
                                    class="d-none d-sm-inline">Download</span></a></div>
                    </div>
