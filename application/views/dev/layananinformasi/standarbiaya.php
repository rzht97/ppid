...
<head>
    <title>Standar Biaya Pelayanan - PPID Kab. Sumedang</title>
                ...
                <div id="pdf-viewer"
                    ...
                    <div id="pdf-controls"
                        ...
                        <div style="display: inline-block; margin: 5px;"><button id="fullscreen-btn"
                                ...
                                href="<?= base_url(); ?>upload/product/SKstandarbiaya.pdf"
                                download="SK_Standar_Biaya.pdf" class="btn btn-sm btn-success" style="margin: 0 5px;"><i
