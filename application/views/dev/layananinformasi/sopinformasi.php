                        ...
                        <div class="services-details__sidebar">
                            <div class="services-details__services-list-box">
                                ...
                                <ul class="services-details__services-list list-unstyled">
                                    <li class="active"><a href="<?php echo site_url('dev/overview/caradapatinfo')?>">Tata Cara Mendapatkan Informasi <span class="icon-right-arrow"></span></a></li>
                                    ...
                                    <li><a href="<?php echo site_url('dev/overview/carasengketa')?>">Prosedur Penanganan Sengketa Informasi<span class="icon-right-arrow"></span></a></li>
                                </ul>
                            </div>
