                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" action="<?php base_url('admin/dokumen/add') ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-md-12">Deskripsi Isi Informasi</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control <?php echo form_error('judul') ? 'is-invalid' : '' ?>" name = "judul" placeholder = "Deskripsi Isi informasi">
                                    </div>
                                </div>
                                <div class="form-group">
