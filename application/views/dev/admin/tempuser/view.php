...
<head>
	<title>Pengajuan Akun - Admin PPID Kab. Sumedang</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Pengajuan Akun</h3>
							<br>
							<br>
                                ...
                                <table id="myTable" class="table table-striped">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td width="250">
												<a href="<?php echo site_url('admin/user/edit/'.$berita_kec->user_id) ?>"class="fcbtn btn btn-outline btn-success btn-1b"><i class="fa fa-edit"></i>detail</a>
											</td>
										</tr>
										<?php endforeach; ?>
									</tbody>
