...
<head>
    <title>Laporan Pelayanan Informasi Publik KAB. SUMEDANG - PPID Kab. Sumedang</title>
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2>LAPORAN PELAYANAN INFORMASI PUBLIK KAB. SUMEDANG</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                        ...
                        <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                            <div class="accrodion">
                                <div class="accrodion-title">
                                    <a target = "_blank" href = "https://ppid.sumedangkab.go.id/upload/laporan/Laporan PPID Tahun 2021.pdf"><h4><span>.</span> Laporan Tahunan Pelayanan Informasi Publik Tahun 2021</h4></a>
                                </div>
								<div class="accrodion-title">
                                    <a target = "_blank" href = "https://ppid.sumedangkab.go.id/upload/laporan/laporan akhir ppid tahun 2022.pdf"><h4><span>.</span> Laporan Tahunan Pelayanan Informasi Publik Tahun 2022</h4></a>
                                </div>
                                <div class="accrodion-title">
                                    <a target = "_blank" href = "https://ppid.sumedangkab.go.id/upload/laporan/laporan akhir ppid tahun 2023.pdf"><h4><span>.</span> Laporan Tahunan Pelayanan Informasi Publik Tahun 2023</h4></a>
                                </div>
								<div class="accrodion-title">
                                    <a target = "_blank" href = "https://ppid.sumedangkab.go.id/upload/laporan/laporan akhir ppid tahun 2024 TTD.pdf"><h4><span>.</span> Laporan Tahunan Pelayanan Informasi Publik Tahun 2024</h4></a>
                                </div>
                            </div>
