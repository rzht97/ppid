                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php base_url('admin/dokumen/add') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="image"> Sumber Dokumen (isi salah satu)</label>
                                <input class="form-control-file <?php echo form_error('image') ? 'is-invalid' : '' ?>" type="file" name="image" /> tipe file: docx,doc,pdf,xlsx
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('judul') ? 'is-invalid' : '' ?>" type="text" name="judul" placeholder="Judul Dokumen" required />
                                <div class="invalid-feedback">
							...
							<hr>
							<div class="form-group">
                                <label for="kategori">Bentuk Informasi Yang Tersedia</label>
