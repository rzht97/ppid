			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/statkec/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('admin/statkec/add_pendidikan') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="judul">Desa*</label>
								<input class="form-control <?php echo form_error('desa') ? 'is-invalid':'' ?>"
								 type="text" name="desa" placeholder="Nama Desa" />
