        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Permohonan Informasi</span></a></li>
                    <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Keberatan Informasi</span></a></li>
                    <!-- <li><a href="index.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Keberatan Informasi</span></a></li> -->
                        ...
                        <div class="white-box">
                            <div class="button-box">
                                <a href="#"><button class="fcbtn btn btn-primary btn-outline btn-1b"><i class="fa fa-plus m-r-5"></i>
                                        <spans>Buat Permohonan Informasi</span>
                                    </button></a>
