...
class Security_headers
{
    ...
    public function inject()
    {
        ...
        $csp = [
            ...
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://code.jquery.com https://maxcdn.bootstrapcdn.com https://translate.google.com https://translate.googleapis.com https://maps.googleapis.com", // Allow inline scripts (untuk compatibility)
            ...
            "connect-src 'self' https://cdn.jsdelivr.net https://translate.google.com https://translate.googleapis.com https://maps.googleapis.com *.sumedangkab.go.id", // AJAX requests
